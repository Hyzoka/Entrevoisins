...
public class NeighbourServiceTest {
    ...
    public void addFavoriteWithSuccess() {
        ...
        service.addNeighbourFavorite(neighbourAddedToFavorites);
        assertTrue(service.getNeighbourFavorit().contains(neighbourAddedToFavorites));
    }
    ...
    public void getFavoriteWithSuccess() {
        ...
        assertEquals(12, service.getNeighbourFavorit().size());
    }
}